...
.method private reportFailedUnlockAttempt(II)V
    ...
    invoke-virtual {v9, v0}, Lcom/android/keyguard/KeyguardUpdateMonitor;->getFailedUnlockAttempts(I)I
    ...
    const-string/jumbo v15, "KeyguardSecurityView"

    new-instance v16, Ljava/lang/StringBuilder;

    invoke-direct/range {v16 .. v16}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v17, "reportFailedPatternAttempt: #"
    ...
    invoke-virtual {v2, v15, v0}, Landroid/app/admin/DevicePolicyManager;->getMaximumFailedPasswordsForWipe(Landroid/content/ComponentName;I)I
    ...
    .line 332
    .local v14, "usingPattern":Z
    :goto_1
    sget-object v15, Lcom/android/keyguard/KeyguardSecurityModel$SecurityMode;->PIN:Lcom/android/keyguard/KeyguardSecurityModel$SecurityMode;
    ...
    .line 333
    .local v12, "usingPIN":Z
    :goto_2
    sget-object v15, Lcom/android/keyguard/KeyguardSecurityModel$SecurityMode;->Password:Lcom/android/keyguard/KeyguardSecurityModel$SecurityMode;
    ...
    .line 335
    sget v16, Lcom/android/keyguard/R$integer;->config_max_unlock_countdown_times:I
    ...
    invoke-direct {v0, v5}, Lcom/android/keyguard/KeyguardSecurityContainer;->showCountdownWipeDialog(I)V
    ...
    invoke-virtual {v9, v0}, Lcom/android/keyguard/KeyguardUpdateMonitor;->reportFailedStrongAuthUnlockAttempt(I)V
    ...
    invoke-virtual {v15, v0}, Lcom/android/internal/widget/LockPatternUtils;->reportFailedPasswordAttempt(I)V
    ...
    invoke-direct {v0, v1}, Lcom/android/keyguard/KeyguardSecurityContainer;->showTimeoutDialog(I)V
    ...
    .line 329
    .end local v3    # "enableTimesCounter":Z
    .end local v7    # "maxCountdownTimes":I
    .end local v10    # "remainingBeforeWipe":I
    .end local v12    # "usingPIN":Z
    .end local v13    # "usingPassword":Z
    .end local v14    # "usingPattern":Z
    :cond_2
    ...
    .restart local v14    # "usingPattern":Z
    goto :goto_1
    ...
    .restart local v13    # "usingPassword":Z
    goto :goto_3
    ...
    .line 341
    .restart local v3    # "enableTimesCounter":Z
    :cond_8
    const/4 v15, 0x5
    ...
    invoke-virtual {v2, v0}, Landroid/app/admin/DevicePolicyManager;->getProfileWithMinimumFailedPasswordsForWipe(I)I
    ...
    invoke-direct {v0, v5, v10, v11}, Lcom/android/keyguard/KeyguardSecurityContainer;->showAlmostAtWipeDialog(III)V
    ...
    const-string/jumbo v17, "Too many unlock attempts; user "
    ...
    const-string/jumbo v17, " will be wiped!"
    ...
    invoke-direct {v0, v5, v11}, Lcom/android/keyguard/KeyguardSecurityContainer;->showWipeDialog(II)V
